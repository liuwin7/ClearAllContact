...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"contactDetailTableViewReusableID" forIndexPath:indexPath];
    cell.textLabel.text = _contactModel.contactName;
    return cell;
}
